...
function admin_header($title='Admin'){
  ...
  if (function_exists('admin_can') && admin_can('manage_affiliates')) {
    echo '<a class="'.($cur==='affiliates.php'?'active':'').'" href="'.cache_bust_url('affiliates.php').'"><i class="fa-solid fa-link"></i>Afiliados</a>';
  }
